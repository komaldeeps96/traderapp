...
/**
 * Load the feed when the symbol changes. The dock runs this whichever tab is
 * open, and it writes to the store, so a live headline over the WebSocket
 * merges into a list that already exists.
 */
